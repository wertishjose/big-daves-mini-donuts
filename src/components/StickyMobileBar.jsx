  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-donut/10 bg-[#fff7ea]/95 px-4 py-3 backdrop-blur-md lg:hidden">
      <div className="mx-auto grid max-w-xl grid-cols-3 gap-3">
        <a href="#find-us" className="inline-flex flex-col items-center justify-center rounded-2xl bg-white px-3 py-3 text-xs font-black uppercase tracking-[0.14em] text-donut shadow-lg shadow-amber-950/10">
